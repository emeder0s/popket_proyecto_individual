...
function NewProduct() {
    ...
    const newP = async e =>{
        e.preventDefault();
        console.log("entro");
        var data = {product_name:e.target.product_name.value,description:e.target.description.value,price:e.target.price.value,image:e.target.image.value,fk_id_space:space};
