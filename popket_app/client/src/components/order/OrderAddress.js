    ...
    return(
        <div className="personal-data-form">
            ...
            <div>
                ...
                <h4>Ya tenías una dirección por defecto ¿Prefieres cambiarla?</h4>
                ...
                <form onSubmit={editData}>
                    ...
                    <input type="text" id='via_name' name='via_name' placeholder='Nombre de la via' required defaultValue={address.via_name}></input>
                    <input type="text" id='via_number' name='via_number' placeholder='Número' required defaultValue={address.via_number}></input>
                    <input type="text" id='additional_address' name='additional_address' placeholder='Información adicional' defaultValue={address.additional_address}></input>
                    <input type="text" id='postal_code' name='postal_code' placeholder='Código Postal' required defaultValue={address.postal_code}></input>
                    <input type="text" id='locality' name='locality' placeholder='Localidad'  defaultValue={address.locality}></input>
                    <input type="text" id='province' name='province' placeholder='Provincia'  defaultValue={address.province}></input>
                    <input type="text" id='country' name='country' placeholder='País'  defaultValue={address.country}></input>
